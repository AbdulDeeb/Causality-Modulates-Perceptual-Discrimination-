...
numBookendFrames = 120 #num frames mover is outside of tube, not touching context objects
numTouchFrames = 120 #num frames mover is outside of tube, touching context objects
numMidFrames = 241 #num frames mover is in tube best if this is odd. 
numFramesLit = 121 #Must be odd, and must be less than numMidFrames
...
allTrials = [[contextTop, attentionUp, causal_condition, directionRight, 'contop_attenup_causal_right'],
             [contextTop, attentionUp, causal_condition, directionLeft,  'contop_attenup_causal_left'],
             
             [contextTop, attentionUp, reverse_condition, directionRight, 'contop_attenup_reverse_right'],
             [contextTop, attentionUp, reverse_condition, directionLeft,  'contop_attenup_reverse_left'],
             
             [contextTop, attentionDown, causal_condition, directionRight, 'contop_attendown_causal_right'],
             [contextTop, attentionDown, causal_condition, directionLeft,  'contop_attendown_causal_left'],
             
             [contextTop, attentionDown, reverse_condition, directionRight, 'contop_attendown_reverse_right'],
             [contextTop, attentionDown, reverse_condition, directionLeft,  'contop_attendown_reverse_left'],
             
             
             [contextBottom, attentionUp, causal_condition, directionRight, 'conbot_attenup_causal_right'],
             [contextBottom, attentionUp, causal_condition, directionLeft,  'conbot_attenup_causal_left'],
             
             [contextBottom, attentionUp, reverse_condition, directionRight, 'conbot_attenup_reverse_right'],
             [contextBottom, attentionUp, reverse_condition, directionLeft,  'conbot_attenup_reverse_left'],
             
             [contextBottom, attentionDown, causal_condition, directionRight, 'conbot_attendown_causal_right'],
             [contextBottom, attentionDown, causal_condition, directionLeft,  'conbot_attendown_causal_left'],
             
             [contextBottom, attentionDown, reverse_condition, directionRight, 'conbot_attendown_reverse_right'],
             [contextBottom, attentionDown, reverse_condition, directionLeft,  'conbot_attendown_reverse_left']]*numTrialsPerCondition
