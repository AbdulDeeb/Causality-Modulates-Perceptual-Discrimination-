...
def CreateTrialFrames(mywin,contextDirection,attentionDirection, trial_condition, direction, contextFrames, moverLeft, moverRight,
                                    ...
                                    topWindow, bottomWindow, flashLocation,stimulusIntensity, fixation, fixationText, trial): #task illuminations
    ...
    for dotpos in contextFrames:
        ...
        if direction == 1:
            ...
            if trial_condition == -1: #reverse_condition (aka 1 -2 3)
                
                if contextDirection == 'Top':
                    if dotpos == 0:
            ...
            elif trial_condition == 1:#causal condition
        ...
        if dotpos == 3 and flashLocation == -1:
        ...
        elif dotpos == 3 and flashLocation == 1:
...
def FindReversals(trialList):
    ...
    performanceMap = [2]
    for index in range(len(trialList)-1):
